      ...
      {visibleRows && visibleRows.length === 0 ? (
        ...
        <>
          <TableContainer sx={{ height: '390px' }}>
            <Table stickyHeader sx={{ minWidth: 1800 }} aria-labelledby='tableTitle'>
              <EnhancedTableHead
                  ...
                  return (
                    <TableRow hover role='checkbox' tabIndex={-1} key={row.id} sx={{ cursor: 'pointer' }}>
                      ...
                      <TableCell align='left'>
                        ...
                        {row.deleted === 1 ? (
                          <EyeOffOutline onClick={() => deleteCompany(row.id)} sx={{ color: '#9155FD' }} />
                        ) : (
                          <EyeOutline onClick={() => deleteCompany(row.id)} sx={{ color: '#9155FD' }} />
                        )}
                      </TableCell>
                    </TableRow>
                  )
