/** @module AdminModal — Dialog wrapper for adding or editing an admin. */
...
/**
 * Renders the Add-Admin button and the admin dialog.
 * @param {object} props - Includes editAdminId, open, scroll and all handler props.
 * @returns {JSX.Element}
 */
const AdminModal = ({ value, editAdminId, adminData, open, setOpen, scroll, handleClickOpen, handleClose, addAdmin, editAdmin }) => {
