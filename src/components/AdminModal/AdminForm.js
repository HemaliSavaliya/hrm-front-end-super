...
import { Button, CardActions, DialogContentText, Divider, FormControl, Grid, IconButton, InputAdornment, InputLabel, MenuItem, OutlinedInput, Select, TextField, Typography } from "@mui/material";
      ...
      <form onSubmit={handleFormSubmit} autoComplete="off">
        <Grid container spacing={5}>
          <Grid item xs={12} sm={6}>
            ...
            />
            {errors.name && <Typography sx={{ color: "#FF4433", fontSize: "13px", fontWeight: "lighter", pt: 1 }}>{errors.name}</Typography>}
          </Grid>
          <Grid item xs={12} sm={6}>
            <TextField
              fullWidth
          ...
          <Grid item xs={12} sm={12} sx={{ mb: 5 }}>
            ...
            {errors.companyId && <Typography sx={{ color: "#FF4433", fontSize: "13px", fontWeight: "lighter", pt: 1 }}>{errors.companyId}</Typography>}
          </Grid>
        </Grid>
        <Divider sx={{ margin: 0 }} />
